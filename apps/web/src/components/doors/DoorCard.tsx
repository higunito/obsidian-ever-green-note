...
export function DoorCard({ door }: DoorCardProps) {
	return (
		<Link
			href={internalHref({ slug: door.slug, layer: door.layer })}
			className="flex items-start gap-2 border-b border-arch-border-faint px-3 py-2 transition-colors last:border-b-0 hover:bg-arch-cyan-faint"
		>
			<span
				aria-hidden
